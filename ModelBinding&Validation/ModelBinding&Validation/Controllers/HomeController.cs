...
namespace ModelBinding_Validation.Controllers
{
    ...
    public class HomeController : Controller
    {
        ...
        public IActionResult Index([FromBody][Bind(nameof(Employee.firstName), nameof(Employee.email), nameof(Employee.dob), nameof(Employee.password), nameof(Employee.confirmPassword))]Employee emp, int? id, bool? isLoggedIn = false)
        {
        ...
        [Route("check")]
        public IActionResult validateEmployee([FromBody] [ModelBinder(BinderType = typeof(CustomEmployeeModelBinder))] Employee emp)
        {
